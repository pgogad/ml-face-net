...
PAIRS_TXT = os.path.join(BASE_DIR, 'data', 'pairs.txt')
DATA_TRAINING = os.path.join(BASE_DIR, 'data', 'learning_rate_schedule.txt')
...
def parse_arguments(argv):
    ...
    parser.add_argument('--lfw_pairs', type=str,
                        help='The file containing the pairs to use for validation.', default=PAIRS_TXT)
    parser.add_argument('--lfw_dir', type=str,
                        help='Path to the data directory containing aligned face patches.', default=OUT_PUT)
